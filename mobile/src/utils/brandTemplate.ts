// Efficient Move brand header/footer shared by invoice & contract PDFs
export const BRAND = {
...
export const brandCss = `
  .brand-header { position: relative; background: #fff; padding: 40px 40px 30px; overflow: hidden; min-height: 120px; }
  ...
  .brand-row { position: relative; display: flex; align-items: center; gap: 16px; }
  ...
  .ft-shape { position: absolute; bottom: 0; left: 0; right: 0; height: 70px; }
